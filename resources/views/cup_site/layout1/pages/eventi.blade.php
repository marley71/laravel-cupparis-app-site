                ...
                @foreach($news as $item)
                    <div class="col-6 mb-5">
                        ...
                        <div class="bg-white p-2 shadow-primary-xs transition-hover-top transition-all-ease-250">
                            <a href="/{{$route_prefix}}/eventi/{{$item['menu_it']}}" class="d-block overflow-hidden overlay-dark-hover overlay-opacity-2 text-decoration-none text-dark">
...
{{--                                    </li>--}}
                                ...
                                <div>
                                    <a href="/{{$route_prefix}}/eventi/{{$item['menu_it']}}">Continua a leggere</a>
                                </div>
                            </div>
                        </div>
